...
import { listMajorProducts } from '../../actions/productActions'
                                ...
                                <div class="product-active">
                                    {
                                        ...
                                        products.map(item => {
                                            return (
                                                <div class="col-lg-12" key={item._id}>
                                                    <div class="single-product-wrap">
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="single-product.html">{item.productName}</a></h4>
                                                                <div class="price-box">
